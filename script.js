...
function getCurrentImageOfTheDay(){
    ...
    fetch(`https://api.nasa.gov/planetary/apod?api_key=P7ZD2gqjKW1TaQPTnHgFAo1oLyFSADdGFz8X2Qt3&date=${date}`)
        .then((res) => {
            return res.json();
        })
        .then((data) => {
...
function getImageOfTheDay(e){
    ...
    fetch(`https://api.nasa.gov/planetary/apod?api_key=P7ZD2gqjKW1TaQPTnHgFAo1oLyFSADdGFz8X2Qt3&date=${newDate}`)
        .then((res) => {
            return res.json();
        })
        .then((data) => {
...
function getUserDate(year, month,date){
    ...
    fetch(`https://api.nasa.gov/planetary/apod?api_key=P7ZD2gqjKW1TaQPTnHgFAo1oLyFSADdGFz8X2Qt3&date=${year}-${month}-${date}`)
        .then((res) => {
            return res.json();
        })
        .then((data) => {
